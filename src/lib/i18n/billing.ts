...
export const billingCopy = {
  ...
  customizeFree: 'Personnaliser vos couleurs',
  signIn: 'Se connecter pour changer d’offre',
  ...
  switchPersonal: 'Choisir un espace personnel',
  switchOrganization: 'Choisir une organisation',
  workspaceHint: 'Choisissez ou créez l’espace correspondant avant de changer d’offre.',
  localHint:
    'Choisissez un espace connecté dans le menu des espaces pour associer une offre à votre compte.',
  ownerOnly: 'Seul le propriétaire de cet espace peut changer l’offre.',
  retry: 'Vérifier à nouveau la disponibilité',
  choosePro: 'Choisir Pro',
  chooseTeam: 'Choisir Team',
  perMonth: '/ mois',
  perYear: '/ an',
  billedAnnually: 'Facturation annuelle. Le montant affiché couvre une année entière.',
  billedMonthly: 'Facturation mensuelle.',
  cancelHint:
    'Gérez le renouvellement, la résiliation, les moyens de paiement et les factures dans Stripe.',
  processing:
    'Vérification du paiement. Les fonctionnalités payantes seront activées après confirmation de Stripe.',
  activated: 'Votre offre payante est active dans cet espace.',
  ...
  scope:
    'Pro est associé à votre espace personnel. Team couvre une organisation ; les espaces personnels restent séparés.',
} as const;
