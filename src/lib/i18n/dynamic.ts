...
const eventLabels: Record<ActivityEvent['type'], string> = {
  ...
  subject_archived: 'Matière archivée',
  subject_restored: 'Matière restaurée',
  subject_completed: 'Matière terminée',
  subject_reopened: 'Matière rouverte',
  note_created: 'Note créée',
  note_updated: 'Note modifiée',
  note_deleted: 'Note supprimée',
  flashcard_deck_created: 'Paquet de cartes créé',
  flashcard_deck_updated: 'Paquet de cartes modifié',
  flashcard_deck_deleted: 'Paquet de cartes supprimé',
  flashcard_created: 'Carte créée',
  flashcard_updated: 'Carte modifiée',
  flashcard_deleted: 'Carte supprimée',
  journal_added: 'Note de travail ajoutée',
  journal_edited: 'Note de travail modifiée',
  focus_completed: 'Séance terminée',
  focus_interrupted: 'Séance interrompue',
  focus_skipped: 'Séance passée',
  plan_created: 'Séance planifiée',
  plan_updated: 'Séance prévue modifiée',
  plan_deleted: 'Séance prévue supprimée',
};
