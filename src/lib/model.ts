...
export function createDemoData(now = new Date()): WorkspaceData {
  ...
  const subjects = [
    {
      name: 'Design produit',
      description: 'Des interfaces soignées, une séance à la fois.',
      icon: '✦',
      color: '#708C64',
      weeklyGoal: 240,
    },
    {
      name: 'Développement',
      description: 'Créer des choses utiles et continuer à apprendre.',
      icon: '⌘',
      color: '#7395B0',
      weeklyGoal: 300,
    },
    {
      name: 'Lecture et apprentissage',
      description: 'Faire une place à la curiosité chaque jour.',
      icon: '▤',
      color: '#B391B5',
      weeklyGoal: 120,
    },
  ...
  data.tasks = [
    {
      title: 'Explorer les idées pour le tableau de bord',
    ...
    {
      title: 'Construire le premier prototype fonctionnel',
    ...
    {
      title: 'Lire un chapitre et noter ses idées',
  ...
  for (let offset = 0; offset < 5; offset++) {
    ...
    data.plannedSessions.push({
      ...
      durationMinutes: 25,
      notes: 'Séance d’exemple. Le travail prévu ne compte pas comme du travail terminé.',
      completed: false,
      createdAt: stamp,
      updatedAt: stamp,
    });
